        ...
        parameters=[
            {
                ...
                'label_obstaculo': ParameterValue(
                    LaunchConfiguration('label_obstaculo'),
                    value_type=int,
                ),
        ...
        parameters=[
            {
                ...
                'distancia_coleta_bandeira': ParameterValue(
                    LaunchConfiguration('distancia_coleta_bandeira'),
                    value_type=float,
                ),
                'limite_obstaculo_semantico_posicionamento': ParameterValue(
                    LaunchConfiguration(
                        'limite_obstaculo_semantico_posicionamento'
                    ),
                    value_type=float,
                ...
                'distancia_aproximacao_bandeira': ParameterValue(
                    LaunchConfiguration('distancia_aproximacao_bandeira'),
                    value_type=float,
                ),
                'margem_borda_bandeira_px': ParameterValue(
                    LaunchConfiguration('margem_borda_bandeira_px'),
                    value_type=float,
                ),
                'area_minima_bandeira_inteira': ParameterValue(
                    LaunchConfiguration('area_minima_bandeira_inteira'),
                    value_type=float,
                ),
                'frames_bandeira_inteira': ParameterValue(
                    LaunchConfiguration('frames_bandeira_inteira'),
                    value_type=int,
                ),
            }
        ],
